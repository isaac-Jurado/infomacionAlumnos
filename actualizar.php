                        ...
                        <form action="servidor/agregarRegistro.php" method="POST" class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input type="text" class="form-control rounded-pill" name="nombre" placeholder="ingresa tu nombre" required pattern="[A-Za-z]{4,15}" value="<?php echo $datos['nombre'] ?>">
                                </div>
                                <div class="col-sm-4">
                                    <label for="apellidoP">Apellido Paterno</label>
                                    <input type="text" class="form-control rounded-pill" name="apellidoP" placeholder="Apellido Paterno" required pattern="[A-Za-z]{4,15}" value="<?php echo $datos['apellidoP'] ?>">
                                </div>
                                <div class="col-sm-4">
                                    <label for="apellidoM">Apellido Materno </label>
                                    <input type="text" class="form-control rounded-pill" name="apellidoM" placeholder="Apellido Materno" required pattern="[A-Za-z]{4,15}" value="<?php echo $datos['apeliidoM'] ?>">
                                </div>
                            </div>
                            <!-- 2° row -->
                            <div class="row mt-3">
                                ...
                                <label for="matricula">matricula</label>
                                    <input type="text" class="form-control rounded-pill" name="matricula" placeholder="ingresa tu matriculas" required pattern="[l0-9]{10}" value="<?php echo $datos['matricula'] ?>">
                                </div>
                                <div class="col-sm-4">
